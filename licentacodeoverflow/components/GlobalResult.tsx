...
import { globalSearch } from "@/lib/actions/SearchAction";
  ...
  return (
    <div className="absolute top-full z-10 mt-3 w-full rounded-xl bg-light-800 py-5 shadow-sm dark:bg-dark-400">
      ...
      <div className="space-y-5">
        <p className="text-dark400_light900 paragraph-bold px-5">Top Match</p>

        {isLoading ? (
          <div className="flex-center flex-col px-5">
            <ReloadIcon className="my-2 size-10 animate-spin text-primary-500" />
            <p className="text-dark200_light800 body-medium">
          ...
          <div className="flex flex-col gap-2">
            {result.length > 0 ? (
              ...
              <div className="flex-center flex-col px-5">
                <p className="text-dark200_light800 body-medium px-5 py-2.5">
                  No results found
                </p>
              </div>
            )}
